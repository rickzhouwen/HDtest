...
#'
#' Testing the equality of two high dimensional covariance matrices using the testing
#' procedure by Li and Chen (2012).
#'
...
#'
#' @return Value of testing statistic, p-value, alternative hypothesis, and the name of
#'    testing procedure.
#'
#' @details Implementing testing procedure proposed by Li and Chen (2012) to test the
#'    equality of two sample high dimensional covariance matrices.
#'
#' @references
#' J. Li and S. Chen (2012). Two sample tests for high-dimensional covariance matrices.
#'    Ann. Statist. 40, 908--940.
#'
...
equalCovs <- function(X, Y, alpha, DNAME){
  ...
  Sd_prime <- 2 * (1 / size1 + 1 / size2) * ((size1 / (size1 + size2)) * A_n1 +
