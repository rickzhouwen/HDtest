...
#'
#' @details Implementing testing procedure proposed by Chen and Qin (2010) to test the
#'    equality of two sample high dimensional mean vectors under the assumption of sparsity
#'    of signals.
#'
#' @return Value of testing statistic, alternative hypothesis, and the name of testing
#'    procedure.
#'
#' @references
