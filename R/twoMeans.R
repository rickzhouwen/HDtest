...
#'
#' Testing the equality of two sample high dimensional mean vectors using the method
...
#'
#' @details Implement the method developed in  arXiv:1406.1939 [math.ST] to test
#'    whether a high dimensional mean vector is zero or not, which is equivalent
#'    to test \eqn{H_0: \mu_1=\mu_2}. The procedure utilizes bootstrap concept and
#'    derive the critical values using independent Gaussian vectors whose covariance is
#'    estimated using sample covariance matrix.
#'
