...
#' different methods.
#'
#' @param X the n x p training data, could be a \code{matrix} or a \code{data.frame}
#'    object.
#' @param Y the n x p training data matrix, could be a \code{matrix} or a
...
#'        is called.
#'
#' @return For any single method, the function returns an \code{htest} object. For
